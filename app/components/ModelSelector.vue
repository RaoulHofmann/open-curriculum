        ...
        <template #content>
            <div class="p-6">
                ...
                <p class="text-sm text-zinc-500 dark:text-zinc-400 mb-5">
                    The model runs entirely in your browser. Pick one based on
                    your speed/accuracy preference.
                </p>
                ...
                <div v-if="isDownloading" class="mb-5">
                    <div
                        class="flex items-center justify-between text-xs text-zinc-500 dark:text-zinc-400 mb-1.5"
                    >
