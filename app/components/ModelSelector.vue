...
<template>
  ...
  >
    <template #content>
      <div class="p-6">
        <h2 class="text-lg font-semibold text-[var(--ui-text-highlighted)] mb-1">
        ...
        <div class="space-y-3 mb-6">
          ...
          >
            <div class="flex items-start justify-between gap-3">
              <div>
                <p class="font-medium text-sm text-[var(--ui-text-highlighted)]">
                  {{ model.name }}
                </p>
        ...
        <div
          ...
          class="mb-5"
        >
          <div class="flex items-center justify-between text-xs text-[var(--ui-text-muted)] mb-1.5">
        ...
        <div
          ...
          class="mb-5 flex items-center gap-2 text-sm text-[var(--ui-success)]"
        >
